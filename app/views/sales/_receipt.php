<?php
// The receipt itself — shown on the receipt page (sales/receipt.php) and
// printed on its own by the desktop app (sales/print.php). Needs $sale,
// $items, $payments, $refunds, $shop.
